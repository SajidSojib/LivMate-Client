...
const Login = () => {
  ...
  return (
    <div className="py-28 min-h-[calc(100vh-250px)] flex flex-col xl:flex-row items-center justify-center">
      <Helmet>
        <title>Login | LivMate</title>
      </Helmet>
        ...
        <div className="card-body">
          <fieldset className="fieldset">
            ...
            <div>
              ...
              <p className="link link-hover font-semibold">Forgot password?</p>
            </div>
