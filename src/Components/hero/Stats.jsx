...
const Stats = ({ data }) => {
  ...
  return (
    <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20 mb-18">
      <h1 data-aos="zoom-in" className="text-4xl font-bold text-center text-primary">Our Growing Community in Numbers</h1>
      <p data-aos="fade-up" className="mt-6 mb-14 text-center text-secondary w-3/4 mx-auto">
